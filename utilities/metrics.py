...
"""
Code adopted from:
https://raw.githubusercontent.com/RanTaimu/M-CE2P/master/metrics/metrics.py
"""
...
class APr():
  """
  """
  def __init__(self, instance_pred_folder, instance_gt_folder, num_classes):
    """
    """
  ...
  def compute_AP(self):
    """
    """
    image_name_list = [x[:-4] for x in os.listdir(self.INSTANCE_PRED_FOLDER) if x[-3:] == 'txt']
    ...
    AP_map = {}
    for i, thre in enumerate(self.IoU_TH[::-1]):
      AP_map[thre] = mAP[i]
