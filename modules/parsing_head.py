...
class ParsingHead(nn.Module):
    ...
    def __init__(self,
                 num_classes,  # number of classes, plus the background
    ...
    def _init_layers(self):
        ...
        for i in range(self.stacked_convs):          
            ...
            self.cate_convs.append(nn.Sequential( nn.Conv2d( chn, self.seg_feat_channels, 3, stride=1, padding=1, bias=norm_cfg is None),
